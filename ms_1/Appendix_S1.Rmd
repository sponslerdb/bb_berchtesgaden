---
title: "The tree line ecotone punctuates the abundance and β-diversity of plants, pollinators, and their interactions"
subtitle: "Appendix S1: Analytical workflow"
author: 
  - Douglas B. Sponsler^[douglas.sponsler@uni-wuerzburg.de]
  - Katharina Kallnik 
  - Fabrice Requier 
  - Alice Classen 
  - A. Fabienne Maihoff
...
ggplot(bb_obs_per_sample, aes(x = "x")) +
  ...
  theme(axis.title.x = element_blank(),
        axis.text.x = element_blank(),
        axis.ticks.x = element_blank()) +
  ggtitle("Samplings (site*day) per year")
...
ggplot(bb_obs_per_sample, aes(x = "x", y = obs)) +
  ...
  theme(axis.title.x = element_blank(),
        axis.text.x = element_blank(),
        axis.ticks.x = element_blank()) +
  ggtitle("Bumble bee observations per sample")
