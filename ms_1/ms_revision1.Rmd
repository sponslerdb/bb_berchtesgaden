...
This study also uses novel code. All data and code required to reproduce our analyses are archived on Dryad: https://doi.org/10.5061/dryad.s1rn8pk7f
...
As an initial analysis, we visualized the relationship between site-wise elevation difference and each metric of $\beta$-diversity, fitting each response with a binomial regression smooth. To investigate the relationship between elevation and $\beta$-diversity more deeply, we performed a second analysis using generalized dissimilarity modeling (GDM) [@Ferrier2007-ji] to analyze the elevational variation in the $\beta$-diversity of bumble bees, flora, and their (unpartitioned) interactions, respectively. In addition to estimating the relationship between differences in a response variable and differences in a predictor variable, GDM captures the slope of this relationship over the range of the predictor variable, revealing potential variation in the amount of change in the response induced by a given change in the predictor [@Ferrier2007-ji]. This enabled us to ask whether the relationship between $\beta$-diversity and elevation exhibits thresholds or other nonlinearities. To control for potential confounding effects of sampling intensity, sampling days per site was included as a covariate. We also included the geographic distances between sites as a covariate to account for potential spatial autocorrelation. The importance of the variables in each model were assessed by a permutation test [@Fitzpatrick-2021aa]. 
...
The response of bumble bee richness to elevation exhibited an approximately linear increase up to 1600-1700 m and then leveled off and declined slightly at the upper limit of the gradient **(Figure 3A)**. The year 2012 had a negative effect (p = 0.04) on bumble bee richness relative to the reference year 2010 **(Figure 3B)**, but neither mowing nor abandonment had a significant effect on bumble bee richness relative to the reference management level of grazing (p > 0.05)  **(Figure 3C; Table 1)** In contrast, the response of floral richness exhibited a clear unimodal pattern, peaking between 1300-1500 m **(Figure 3D)**. The years 2011 (p < 0.001) and 2012 (p < 0.03) had a negative effects on floral richness relative to the reference year 2010 **(Figure 3E)**, but again management had no significant effect (p > 0.1) **(Figure 3F; Table 1)**. The response of interaction richness to elevation was intermediate to that of bumble bee and floral richness, peaking around 1500 m and leveling off at higher elevation **(Figure 3G)**. The effect of year 2011 on interaction richness was positive (p < 0.05) and that of year 2012 negative (p < 0.001) **(Figure 3H)**, but management did not have a significant effect (p > 0.1) **(Figure 3I; Table 1)**.

Cumulative bumble bee abundance did not respond significantly to elevation (p > 0.1) **(Figure 4A)** or management (p > 0.1) **(Figure 4C)**, but the year 2011 had a positive effect (p = 0.03) on bumble bee abundance relative to the reference year of 2010 **(Figure 4B; Table 2)**. Floral abundance, however, peaked around 1000 and exhibited an approximately quadratic decline with increasing elevation (p = 0.003) **(Figure 4D)**. The effect of year 2012 was negative (p = 0.002) relative to the reference year 2010 (p = 0.02) **(Figure 4E)**, and the effect of abandoned meadows on floral abundance was positive compared to the reference level of grazed meadows **(Figure 4F; Table 2)**.
...
**Figure 3:** Conditional effects of elevation, year, and management on the richness of bumble bee species (A), floral species (B), and bumble- bee-flower interactions (C). Effects are plotted on the link scale, and shaded bands depict 95% confidence intervals. Bumble bee and plant illustrations were obtained from http://phylopic.org/; see Appendix S1 for details and licensing. 
...
**Figure 6:** Species-level (A) and interaction-level (B, C) $\beta$-diversity (in terms of proportional turnover) plotted against elevational difference. Each point represents the $\beta$-diversity (or $\beta$-diversity partition) between a pair of sites, and lines represent the overall relationship between $\beta$-diversity and elevation difference using binomial regression smooths. Interaction $\beta$-diversity (B, C) is partitioned using Poisot et al.’s (2012) notation: WN = unpartitioned $\beta$-diversity, ST = $\beta$-diversity due to species turnover, OS =  $\beta$-diversity due to interaction rewiring, ST.h = $\beta$-diversity due to species turnover in the higher trophic level (bumble bees), ST.l = $\beta$-diversity due to species turnover in the lower trophic level (plants), and ST.lh =  $\beta$-diversity due to joint species turnover in higher and lower trophic levels.
