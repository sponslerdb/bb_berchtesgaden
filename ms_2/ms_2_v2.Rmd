...
The role of competition in regulating community assembly and species coexistence has long been a central question in ecology. It has taken on new urgency, however, on account of recent climate change, which threatens to disrupt existing patterns of species interactions [@Tylianakis2008-fi], including competition [@Ettinger2017-pk], with consequences for community composition and function. These effects are likely to be most pronounced along the steep climate gradients of mountain slopes, where climate-induced range shifts are expected to introduce novel competitive interactions within trophic levels and cause spatial or phenological mismatches between organisms and their food resources.  

Bumble bees (Hymenoptera: *Bombus* spp.) have become classic model organisms for the study of competition and species coexistence due to their broad and overlapping distributions and their gross similarity in morphology, behavior, and dietary niche [@Plowright1984-lc; @Goulson2008-zy]. In this role, however, bumble bees have proven somewhat enigmatic. On the one hand, there is evidence that resource limitation can be a significant constraint on local bumble communities [@Heinrich1976-wc; @Bowers1985-df], and certain bumble bee communities have been shown to be over-dispersed in terms of tongue length (a matching trait corresponding to floral corolla depth) or phylogeny (understood to encompass unmeasured trait variation), providing evidence for competition as a community assembly process [@Inouye1977-kl; @Pellissier2013-pk]. Nevertheless, bumble bee communities with an apparent excess of species richness and deficit of trait (or phylogenetic) dispersion are commonly observed [@Ranta1981-vx; @Goulson2008-zy]. Teasing apart the still-obscure mechanisms of bumble bee coexistence and niche partitioning remains a salient problem in basic ecology, but it has also become an urgent question in the context of conservation. Bumble bees are cold-adapted species [@Heinrich1994-cv] associated mainly with mountain habitats, where they serve as the principal pollinators of many alpine plants [@Williams1998-xi; @Goulson2010-lo]. Warming climates have already driven measurable elevational range shifts in bumble bees and their floral hosts [@Ploquin2013-da; @Kerr2015-dg; @Pyke2016-ll; @Fourcade2019-ct; @Soroye2020-zb; @Marshall2020-pc], and these are predicted to cause declines or even extinction in many bumble bees species [@Soroye2020-zb]. One mechanism by which climate change is expected to affect bumble bees is via the introduction of novel interspecific competition driven by the advance of lowland bumble bee species into the elevational distributions of their highland counterparts. Thus, the speculative question of how competition has acted in the historic assembly of bumble bee communities has become an unfolding process observable over ecological time scales.

All else held equal, species coexistence is favored when intraspecific competition exceeds interspecific competition, and this stabilizing inequality is favored to the extent that species differ in fundamental dietary niche [@Abrams1977-zp; @Chesson2000-aw]. Bumble bees are exceptionally versatile foragers whose ability to solve the puzzles posed by complex flower morphologies [Plowright1984-lc], or indeed by human investigators [@Alem2016-rn; @Loukola2017-bt], renders almost any flower potentially accessible. Nevertheless, the flexibility of bumble bee foraging is tuned to floral reward, which depends on both the intrinsic reward of a given flower and the costs associated with exploiting it. These costs are closely related to the morphological fittedness between bumble bee species and their floral hosts. Bumble bees and flowers vary in an array of interrelated morphological parameters, both within and between species, but for bumble bees, morphological variation consists principally (though not exclusively) of variation in tongue length. Floral handling time depends on the degree of match between bumble bee tongue length and floral corolla depth [@Inouye1980-mv], and there is a well-established (though imperfect) association between tongue length and floral choice. Importantly, though, accessing floral reward involves more than just a match between tongue length and corolla depth, and in some flowers access to floral rewards involves learning to manipulate floral structures that are challenging irrespective of tongue length (Laverty 1994). For example, the characteristic Papilionaceous floral morphology of legumes requires a bee to separate tightly appressed keel petals to access anthers and nectaries (Westerkamp 1997), and the narrowly campanulate flowers of many Ericaceous flora pose a significant barrier to large-bodied visitors like bumble bees (Wallace 1977). Thus the dietary niche of a given bumble bee species in a given ecological context is an emergent product of innate floral biases, rewards experienced during foraging, and learned flower handling skills, and all of which contribute to the phenomenon of interspecific niche overlap upon which competition is predicated.

Empirical measurements of niche overlap, however, are inherently equivocal in their interpretation with respect to competition [@Pianka1972-oi; @Pianka1974-qk; @Abrams1980-am]. Low niche overlap between two species, for example, could be interpreted prospectively as an indication that the *potential* for interspecific competition is low, but the same pattern could also be interpreted retrospectively as a mitigating response to high interspecific competition. Which of these interpretations is most plausible hinges on how closely species' observed niches approximate their fundamental niches (within a given resource context). Where observed niches are close to absolute niches, low niche overlap is an indication of low potential for interspecific competition. Any difference between observed and fundamental niches, though, might be attributable to competition-driven niche partitioning, and niche overlap as a reflection of potential competition cannot be distinguished from niche overlap as a response to realized competition. In other words, niche overlap can only be intepreted as an index of *potential* competition if *realized* competition is assumed to be negligible, and this assumption can only be justified on the basis of additional knowledge of the study system under consideration.
...
<!-- 
That one paper [@Zhongming2020-xj] simply equated diet overlap with competition, and I think that is a mistake. But I think we can make a more nuanced case for its use as an index of potential competition. Indeed, Ingolf interpreted diet overlap in exactly this sense in one of his early papers [@Steffan-Dewenter2000-ll]. In fact, there is a slew of papers, from across a wide range of study systems and organisms, that use the term "potential competition" to interpret diet overlap. I think I'm on solid ground.
-->
...
Importantly, our study system is one of rich floral resources and harsh abiotic conditions, and it is likely that competition is low, or at least transient, and that bumble bees are limited instead by abiotic conditions during the critical period of spring colony founding. Thus, the patterns in our data likely represent floral choice unconstrained by competition and therefore approximate the absolute dietary niches of the species involved (within the context of the studied floral community). On this basis, we argue for the interpretation of niche overlap as an index of *potential* competition rather than a response to *realized* competition, with the caveat this interpretation may misrepresent certain temporal intervals (e.g. early spring colony founding) or elevational bands (e.g. the sparse alpine grasslands above the tree line ecotone, which in our system falls around 1500 m). 

We first ask how floral biases compare across bumble bee species whether these patterns can be explained by implicit trait-matching between bumble bee tongue length and floral morphotype. We then investigate the patterns of dietary niche overlap between bumble bee species that emerge from their respective floral biases, comparing niche overlap at the nested levels of floral morphotype, floral family, and floral genus. Finally, we ask how niche overlap varies with elevation. With respect to elevation, we analyze both pairwise niche overlap and community mean niche overlap, since low pairwise niche overlap could conceal a high potential for diffuse competition [@Pianka1974-qk; MacArthur1972-qz]. We discuss the implications of these findings for bumble bee conservation in a changing climate
