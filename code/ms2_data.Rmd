...
write_csv(fl_traits, "../data/processed_data/fl_traits.csv")
```
...
write_csv(visitation, "../data/processed_data/visitation.csv")
...
write_csv(visit_cover, "../data/processed_data/visit_cover.csv")
