...
spline_prep <- function(x, y) {
  isplineExtract(x) %>%
    ...
    pivot_longer(cols = c(x.Geographic, x.elev.mean), 
                 names_to = "x.var", values_to = "predictor", 
                 names_prefix = "x.") %>%
    pivot_longer(cols = c(y.Geographic, y.elev.mean), 
...
p <- c("OS" = "#e7298a", "ST" = "#d95f02", 
       "ST.h" = "#7570b3", "ST.l" = "#1b9e77", 
       "ST.lh" = "#66a61e", "WN" = "black")
