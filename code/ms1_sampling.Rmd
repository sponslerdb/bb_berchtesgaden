...
samplingplot4 <- ggplot(bb_obs_per_sample, aes(as_date(yday(date)), elev.mean/10)) +
...
ggsave("../ms_1/figures/samplingplot.pdf", height = 6, width = 10.5)
ggsave("../ms_1/figures/samplingplot.png", height = 6, width = 10.5)
```