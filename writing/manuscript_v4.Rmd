...
# Results
## Cumulative bias across species and sites
```{r}
knitr::include_graphics("../output/brm.plantsp0_plot1.png")
```

## Parsing bias by floral morphotype [representation ~ 1 + (1 + ktype) + (1 + site)]

## Linking morphological bias to species' traits [bias ordination w/ tongue length]
