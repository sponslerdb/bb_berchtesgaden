...
ggplot(filter(fl_survey_elev_genus, sites > 0), 
       aes(reorder(genus, elev.med), elev.mean)) +
  geom_line(size = 1, color = "gray60") +
  geom_point(alpha = 0.5) +
  theme_light(10) +
  #theme(axis.text.x = element_blank()) +
...
plot(sm(fl_rich_yday.vis, 1)) +
  l_fitRaster() +
  l_fitContour() +
  l_points() +
  ggtitle("FL richness 2010 (yday)") +
  xlab("Day of year") +
  ylab("Elevation")
plot(sm(fl_rich_yday.vis, 2)) +
  l_fitRaster() +
  l_fitContour() +
  l_points() +
  ggtitle("FL richness 2011 (yday)") +
  xlab("Day of year") +
  ylab("Elevation")
plot(sm(fl_rich_yday.vis, 3)) +
  l_fitRaster() +
  l_fitContour() +
  l_points() +
  ggtitle("FL richness 2012 (yday)") +
  xlab("Day of year") +
  ylab("Elevation")
