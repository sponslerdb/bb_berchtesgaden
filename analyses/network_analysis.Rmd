...
### Now let's try all this with GLMMs
```{r}
##### niche overlap
lmer_niche.overlap <- lmer(niche.overlap.HL ~ elev.mean + 
                            I(elev.mean^2) +
                            I(elev.mean^3) +
                            bb.rich +
                            fl.rich +
...
step(lmer_niche.overlap,reduce.random=FALSE) # stepwise variable selection; commented-out variables were removed based on the results of this step
summary(glm_niche.overlap)

#####  c-score
lmer_c.score <- lmer(C.score.HL ~ elev.mean + 
                            I(elev.mean^2) +
                            I(elev.mean^3) +
                            bb.rich +
                            fl.rich +
...
step(lmer_c.score,reduce.random=FALSE) # stepwise variable selection; commented-out variables were removed based on the results of this step
summary(lmer_c.score)
