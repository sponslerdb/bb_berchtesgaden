...
### Call models
weighted_fl_abundance.2010.qp <- bam(fl.abund.wt ~ s(bb.sp, bs = "re") + management + slope.est + te(yday, elev.mean, 
                                                            by = bb.sp,
                                                            bs= c("tp", "tp"), 
                                                            k=c(10, 10), m=1),
...
weighted_fl_abundance.2010.qp2 <- bam(sqrt(fl.abund.wt) ~ s(bb.sp, bs = "re") + management + slope.est + te(yday, elev.mean, 
                                                            by = bb.sp,
                                                            bs= c("tp", "tp"), 
                                                            k=c(10, 10), m=1),
                        data = filter(fl_abund_wt, year == 2010),
...
weighted_fl_abundance.2011.qp <- bam(fl.abund.wt ~ s(bb.sp, bs = "re") + management + slope.est + te(yday, elev.mean, 
                                                            by = bb.sp,
                                                            bs= c("tp", "tp"), 
                                                            k=c(10, 10), m=1),
...
weighted_fl_abundance.2011.qp2 <- bam(sqrt(fl.abund.wt) ~ s(bb.sp, bs = "re") + management + slope.est + te(yday, elev.mean, 
                                                            by = bb.sp,
                                                            bs= c("tp", "tp"), 
                                                            k=c(10, 10), m=1),
                        data = filter(fl_abund_wt, year == 2011),
...
weighted_fl_abundance.2012.qp <- bam(fl.abund.wt ~ s(bb.sp, bs = "re") + management + slope.est + te(yday, elev.mean, 
                                                            by = bb.sp,
                                                            bs= c("tp", "tp"), 
                                                            k=c(10, 10), m=1),
