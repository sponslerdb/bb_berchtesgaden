...
# Subset predictions
predict_major.FL <- filter(predict_pool.FL, 
                           bb.sp %in% c("bss", "pasc", "prat", "soro", "wurf")) %>%
  mutate(bb.sp = case_when(
    bb.sp == "bss" ~ "B. sensu-strictu",
    bb.sp == "pasc" ~ "B. pascuorum",
    bb.sp == "prat" ~ "B. pratorum",
    bb.sp == "soro" ~ "B. soroensis",
    bb.sp == "wurf" ~ "B. wurflenii"
  ))
predict_major.FL.sqrt <- filter(predict_pool.FL.sqrt, 
                                bb.sp %in% c("bss", "pasc", "prat", "soro", "wurf")) %>%
  mutate(bb.sp = case_when(
    bb.sp == "bss" ~ "B. sensu-strictu",
    bb.sp == "pasc" ~ "B. pascuorum",
...
predict_major.FL.bin <- filter(predict_pool.FL.bin, 
                               bb.sp %in% c("bss", "pasc", "prat", "soro", "wurf")) %>%
  mutate(bb.sp = case_when(
    bb.sp == "bss" ~ "B. sensu-strictu",
    bb.sp == "pasc" ~ "B. pascuorum",
...
predict_highelev.FL <- filter(predict_pool.FL, 
...
predict_highelev.FL.sqrt <- filter(predict_pool.FL.sqrt, 
                                   bb.sp %in% c("pyre", "mend", "mont")) %>%
  mutate(bb.sp = case_when(
    bb.sp == "pyre" ~ "B. pyrenaeus",
    bb.sp == "mend" ~ "B. mendax",
...
predict_highelev.FL.bin <- filter(predict_pool.FL.bin, 
                                  bb.sp %in% c("pyre", "mend", "mont")) %>%
  mutate(bb.sp = case_when(
    bb.sp == "pyre" ~ "B. pyrenaeus",
    bb.sp == "mend" ~ "B. mendax",
...
predict_minor.FL <- filter(predict_pool.FL, 
...
predict_minor.FL.sqrt <- filter(predict_pool.FL.sqrt, 
                                bb.sp %in% c("gers", "hort", "hypn","jone", "lapi", "muci")) %>% 
  mutate(bb.sp = case_when(
    bb.sp == "gers" ~ "B. gerstaeckeri",
    bb.sp == "hort" ~ "B. hortorum",
...
predict_minor.FL.bin <- filter(predict_pool.FL.bin, 
                               bb.sp %in% c("gers", "hort", "hypn","jone", "lapi", "muci")) %>% 
  mutate(bb.sp = case_when(
    bb.sp == "gers" ~ "B. gerstaeckeri",
    bb.sp == "hort" ~ "B. hortorum",
...
predict_major.BB <- filter(predict_pool.BB, 
                           bb.sp %in% c("bss", "pasc", "prat", "soro", "wurf")) %>%
  mutate(bb.sp = case_when(
    bb.sp == "bss" ~ "B. sensu-strictu",
    bb.sp == "pasc" ~ "B. pascuorum",
...
predict_highelev.BB <- filter(predict_pool.BB, 
                              bb.sp %in% c("pyre", "mend", "mont")) %>%
  mutate(bb.sp = case_when(
    bb.sp == "pyre" ~ "B. pyrenaeus",
    bb.sp == "mend" ~ "B. mendax",
...
predict_minor.BB <- filter(predict_pool.BB, 
                           bb.sp %in% c("gers", "hort", "hypn","jone", "lapi", "muci")) %>%
  mutate(bb.sp = case_when(
    bb.sp == "gers" ~ "B. gerstaeckeri",
    bb.sp == "hort" ~ "B. hortorum",
...
### FL GAMS
#### Major
ggplot(predict_major.FL, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = pred), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "log(wt. abund.)") +
  facet_grid(year~bb.sp, ) +
  xlab("Date") +
  ylab("Elevation (m)") +
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_major_FL.png")

ggplot(predict_major.FL.sqrt, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = pred), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "log(wt. abund.)") +
  facet_grid(year~bb.sp) +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_major_FL_sqrt.png") 

ggplot(predict_major.FL.bin, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = pred), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "log(wt. abund.)") +
  facet_grid(year~bb.sp) +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_major_FL_bin.png") 

#### High Elev
ggplot(predict_highelev.FL, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = pred), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "log(wt. abund.)") +
  facet_grid(year~bb.sp) +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_highelev_FL.png") 

ggplot(predict_highelev.FL.sqrt, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  scale_fill_viridis_c(name = "log(wt. abund.)") +
  facet_grid(year~bb.sp) +
  xlab("Date") +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_highelev_FL_sqrt.png") 

ggplot(predict_highelev.FL.bin, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = pred), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "log(wt. abund.)") +
  facet_grid(year~bb.sp) +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_highelev_FL_bin.png") 

#### Minor
ggplot(predict_minor.FL, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = pred), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "log(wt. abund.)") +
  facet_grid(year~bb.sp) +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_minor_FL.png") 

ggplot(predict_minor.FL.sqrt, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = pred), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "log(wt. abund.)") +
  facet_grid(year~bb.sp) +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_minor_FL_sqrt.png") 

ggplot(predict_minor.FL.bin, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = pred), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "log(wt. abund.)") +
  facet_grid(year~bb.sp) +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_minor_FL_bin.png") 

### BB GAMs
ggplot(predict_major.BB, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = log(pred)), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "wt. abund.") +
  facet_grid(year~bb.sp) +
  xlab("Date") +
  ylab("Elevation (m)") +
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_major_BB.png")  

ggplot(predict_highelev.BB, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = log(pred)), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "wt. abund.") +
  facet_grid(year~bb.sp) +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_highelev_BB.png") 

ggplot(predict_minor.BB, aes(date, elev.mean, fill = pred)) +
  geom_raster() +
  geom_contour(aes(z = log(pred)), color = "black", size = 0.25) +
  scale_fill_viridis_c(name = "wt. abund") +
  facet_grid(year~bb.sp) +
  ...
  theme(strip.text.x = element_text(face = "italic"),
        axis.text.x = element_text(angle = 90, vjust = 1, hjust = 1))
ggsave("./output/GAM_minor_BB.png") 
```