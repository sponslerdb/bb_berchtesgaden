...
# Early
ggplot(filter(visitation_abund.sp, period == "early"), 
       aes(area = prop, fill = k.type.ss, label = plant.genus)) +
...
# Mid
ggplot(filter(visitation_abund.sp, period == "mid"), 
       aes(area = prop, fill = k.type.ss, label = plant.genus)) +
  geom_treemap(color = "black") +
  geom_treemap_text(fontface = "italic", color = "black", place = "centre", "grow" = TRUE, alpha = 0.5) +
  scale_fill_manual(values = cols) + 
...
# Late
ggplot(filter(visitation_abund.sp, period == "late"), 
       aes(area = prop, fill = k.type.ss, label = plant.genus)) +
  geom_treemap(color = "black") +
  geom_treemap_text(fontface = "italic", color = "black", place = "centre", "grow" = TRUE, alpha = 0.5) +
  scale_fill_manual(values = cols) + 
