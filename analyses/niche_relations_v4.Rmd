...
pcoa_plot <- function(x, min_score = 0.25) {
  ...
  ggplot(filter(x, (abs(MDS1) > min_score | abs(MDS2) > min_score) | (Score == "BB.sp"))) + # no threshold for BB spp
    ...
    ggrepel::geom_text_repel(aes(MDS1, MDS2, color = Score, label = Label), key_glyph = "rect", size = 3) + # add labels
...
beta_func <- function(x, traits, sitedata, level, criterion, binary, ...) {
  ...
  x %>% 
    ...
    group_by(site, !!level, !!criterion, ...) %>% # in addition to grouping by level (bb.sp/pbl.fac) and criterion (plant.sp/k.type.s), the ... argument will also group by any variables supplied in the function call, e.g. elev.class, period, year.
...
niche_oben.tax.plot <- filter(niche_x_elev.tax, elev.class == "oben")$pcoa.plot[[1]] + ggtitle("Oben/Tax")
niche_mitte.tax.plot <- filter(niche_x_elev.tax, elev.class == "mitte")$pcoa.plot[[1]] + ggtitle("Mitte/Tax")
niche_unten.tax.plot <- filter(niche_x_elev.tax, elev.class == "unten")$pcoa.plot[[1]] + ggtitle("Unten/Tax")

# Morphological
niche_x_elev.morph <- niche_analysis(net, bb_traits, criterion = k.type.s, elev.class)

## Extract and name plots
niche_oben.morph.plot <- filter(niche_x_elev.morph, elev.class == "oben")$pcoa.plot[[1]] + ggtitle("Oben/morph")
niche_mitte.morph.plot <- filter(niche_x_elev.morph, elev.class == "mitte")$pcoa.plot[[1]] + ggtitle("Mitte/morph")
niche_unten.morph.plot <- filter(niche_x_elev.morph, elev.class == "unten")$pcoa.plot[[1]] + ggtitle("Unten/morph")

## Display plots on grid
pdf("../analyses/output/niche_x_elev_pcoa.pdf", height = 8.5, width = 11)
(niche_oben.tax.plot | niche_oben.morph.plot) /
(niche_mitte.tax.plot | niche_mitte.morph.plot) /
(niche_unten.tax.plot | niche_unten.morph.plot) + plot_layout(guides = 'collect') 
dev.off()
```
...
## Extract and name plots
niche_oben_early.tax.plot <- filter(niche_x_elevperiod.tax, elev.class == "oben" & period == "early")$pcoa.plot[[1]] 
niche_oben_mid.tax.plot <- filter(niche_x_elevperiod.tax, elev.class == "oben" & period == "mid")$pcoa.plot[[1]] 
niche_oben_late.tax.plot <- filter(niche_x_elevperiod.tax, elev.class == "oben" & period == "late")$pcoa.plot[[1]]

niche_mitte_early.tax.plot <- filter(niche_x_elevperiod.tax, elev.class == "mitte" & period == "early")$pcoa.plot[[1]]
niche_mitte_mid.tax.plot <- filter(niche_x_elevperiod.tax, elev.class == "mitte" & period == "mid")$pcoa.plot[[1]] 
niche_mitte_late.tax.plot <- filter(niche_x_elevperiod.tax, elev.class == "mitte" & period == "late")$pcoa.plot[[1]]

niche_unten_early.tax.plot <- filter(niche_x_elevperiod.tax, elev.class == "unten" & period == "early")$pcoa.plot[[1]]
niche_unten_mid.tax.plot <- filter(niche_x_elevperiod.tax, elev.class == "unten" & period == "mid")$pcoa.plot[[1]]
niche_unten_late.tax.plot <- filter(niche_x_elevperiod.tax, elev.class == "unten" & period == "late")$pcoa.plot[[1]]

# Morphological
niche_x_elevperiod.morph <- niche_analysis(net, bb_traits, criterion = k.type.s, elev.class, period)

## Extract and name plots
niche_oben_early.morph.plot <- filter(niche_x_elevperiod.morph, elev.class == "oben" & period == "early")$pcoa.plot[[1]] +
  ggtitle("Oben/Early/Morph")
niche_oben_mid.morph.plot <- filter(niche_x_elevperiod.morph, elev.class == "oben" & period == "mid")$pcoa.plot[[1]] +
  ggtitle("Oben/Mid/Morph")
niche_oben_late.morph.plot <- filter(niche_x_elevperiod.morph, elev.class == "oben" & period == "late")$pcoa.plot[[1]] +
  ggtitle("Oben/Late/Morph")

niche_mitte_early.morph.plot <- filter(niche_x_elevperiod.morph, elev.class == "mitte" & period == "early")$pcoa.plot[[1]] +
  ggtitle("Mitte/Early/Morph")
niche_mitte_mid.morph.plot <- filter(niche_x_elevperiod.morph, elev.class == "mitte" & period == "mid")$pcoa.plot[[1]] +
  ggtitle("Mitte/Mid/Morph")
niche_mitte_late.morph.plot <- filter(niche_x_elevperiod.morph, elev.class == "mitte" & period == "late")$pcoa.plot[[1]] +
  ggtitle("Mitte/Late/Morph")

niche_unten_early.morph.plot <- filter(niche_x_elevperiod.morph, elev.class == "unten" & period == "early")$pcoa.plot[[1]] +
  ggtitle("Unten/Early/Morph")
niche_unten_mid.morph.plot <- filter(niche_x_elevperiod.morph, elev.class == "unten" & period == "mid")$pcoa.plot[[1]] +
  ggtitle("Unten/Mid/Morph")
niche_unten_late.morph.plot <- filter(niche_x_elevperiod.morph, elev.class == "unten" & period == "late")$pcoa.plot[[1]] +
  ggtitle("Unten/Late/Morph")

## Display plots on grid
#pdf("../analyses/output/niche_x_elevperiod_pcoa_tax.pdf", height = 8.5, width = 11)
(niche_oben_early.tax.plot | niche_oben_mid.tax.plot  | niche_oben_late.tax.plot) /
(niche_mitte_early.tax.plot | niche_mitte_mid.tax.plot | niche_mitte_late.tax.plot) /
(niche_unten_early.tax.plot | niche_unten_mid.tax.plot  | niche_unten_late.tax.plot)  + plot_layout(guides = 'collect') 
#dev.off()

#pdf("../analyses/output/niche_x_elevperiod_pcoa_morph.pdf", height = 8.5, width = 11)
(niche_oben_early.morph.plot | niche_oben_mid.morph.plot  | niche_oben_late.morph.plot) /
(niche_mitte_early.morph.plot | niche_mitte_mid.morph.plot | niche_mitte_late.morph.plot) /
(niche_unten_early.morph.plot | niche_unten_mid.morph.plot  | niche_unten_late.morph.plot)  + plot_layout(guides = 'collect') 
#dev.off()
```
...
visitation_tax_abund.sp <- net %>%
  ...
  group_by(period, elev.class, plant.genus, k.type.ss, plant.family, bb.sp) %>%
  summarize(abund = n()) %>%
  group_by(elev.class, period, bb.sp) %>%
  mutate(prop = abund/sum(abund)) %>%
  arrange(elev.class, period, bb.sp, -prop) 
...
```{r}
### Visitation by BB species, parsed by elev.class and period
visitation_abund.sp <- net %>%
  ...
  mutate(k.type.ss = factor(k.type.ss),
         bb.sp = factor(bb.sp, levels = c("hort", "pasc", "wurf", "bss", "prat", "soro"))) %>%
  group_by(period, elev.class, plant.sp.abb, plant.genus, k.type.ss, plant.family, bb.sp) %>%
  summarize(abund = n()) %>%
  group_by(elev.class, period, bb.sp) %>%
  mutate(prop = abund/sum(abund)) %>%
  arrange(elev.class, period, bb.sp, -prop) 
...
tp.early <- ggplot(filter(visitation_abund.sp, period == "early"), 
  ...
  facet_grid(fct_rev(elev.class)~bb.sp)
...
pdf("./output/tree_ord_early.pdf", width = 14, height = 7)
(tp.early | (niche_oben_early.tax.plot / niche_mitte_early.tax.plot / niche_unten_early.tax.plot) + plot_layout(guides = 'collect')) + plot_layout(widths = c(3, 1))
dev.off()

pdf("./output/tree_ord_mid.pdf", width = 14, height = 7)
(tp.mid | (niche_oben_mid.tax.plot / niche_mitte_mid.tax.plot / niche_unten_mid.tax.plot) + plot_layout(guides = 'collect')) + plot_layout(widths = c(3, 1))
dev.off()

pdf("./output/tree_ord_late.pdf", width = 14, height = 7)
(tp.late | (niche_oben_late.tax.plot / niche_mitte_late.tax.plot / niche_unten_late.tax.plot) + plot_layout(guides = 'collect')) + plot_layout(widths = c(3, 1))
dev.off()
...
```{r, echo = FALSE}
# By plant.sp
ggplot(niche_x_elevperiod.tax, aes(elev.class, adonis.r2)) +
  geom_boxplot() 
...
# By ktype
ggplot(niche_x_elevperiod.morph, aes(elev.class, adonis.r2)) +
  geom_boxplot()
