...
mod <- gam(Petal.Width ~ Species +
             te(Sepal.Length, Sepal.Width, by = Species),
           data = data)

effects <- ggeffect(mod)
means <- ggemmeans(mod)
pred <- ggpredict(mod)
```
...
check.gamViz(bb_abund.2010.2)
bb_abund.2010.sum <- summary(bb_abund.2010)
print(plot(bb_abund.2010, allTerms = TRUE), pages = 1)
bb_abund.2010.ck <- check2D(bb_abund.2010, x1 = "yday", x2 = "elev.mean")
bb_abund.2010.ck + l_gridCheck2D(gridFun = mean)
...
concurvity(bb_abund.2011)
bb_abund.2011.sum <- summary(bb_abund.2011)
print(plot(bb_abund.2011, allTerms = TRUE), pages = 1)
bb_abund.2011.ck <- check2D(bb_abund.2011, x1 = "yday", x2 = "elev.mean")
bb_abund.2011.ck + l_gridCheck2D(gridFun = mean)
...
bb_abund.2012.ck <- check2D(bb_abund.2012, x1 = "yday", x2 = "elev.mean")
bb_abund.2012.ck + l_gridCheck2D(gridFun = mean)
```


### Tabulate plots
```{r}
t1 <- ggpredict(bb_abund.2010, terms = c("elev.mean"))
plot(t1)

bss2010 <- plot(sm(bb_abund.2010, 4)) +
  l_fitRaster() +
...
bss2011 <- plot(sm(bb_abund.2011, 4)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  l_points() +
  labs(title = expression(italic("B. terrestris/lucorum")), x = NULL, y = NULL)
bss2012 <- plot(sm(bb_abund.2012, 4)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
gers2010 <- plot(sm(bb_abund.2010, 5)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  l_points() +
...
gers2012 <- plot(sm(bb_abund.2012, 5)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
hort2010 <- plot(sm(bb_abund.2010, 6)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. hortorum")), x = NULL, y = NULL)
hort2011 <- plot(sm(bb_abund.2011, 5)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. hortorum")), x = NULL, y = NULL)
hort2012 <- plot(sm(bb_abund.2012, 6)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
hypn2010 <- plot(sm(bb_abund.2010, 7)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. hypnorum")), x = NULL, y = NULL)
hypn2011 <- plot(sm(bb_abund.2011, 6)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
jone2010 <- plot(sm(bb_abund.2010, 8)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. jonellus")), x = NULL, y = NULL)
jone2011 <- plot(sm(bb_abund.2011, 7)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. jonellus")), x = NULL, y = NULL)
jone2012 <- plot(sm(bb_abund.2012, 7)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
lapi2011 <- plot(sm(bb_abund.2011, 8)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. lapidarius")), x = NULL, y = NULL)
lapi2012 <- plot(sm(bb_abund.2012, 8)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
mend2010 <- plot(sm(bb_abund.2010, 9)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. mendax")), x = NULL, y = NULL)
mend2011 <- plot(sm(bb_abund.2011, 9)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. mendax")), x = NULL, y = NULL)
mend2012 <- plot(sm(bb_abund.2012, 9)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
mont2010 <- plot(sm(bb_abund.2010, 10)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. monticola")), x = NULL, y = NULL)
mont2011 <- plot(sm(bb_abund.2011, 10)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. monticola")), x = NULL, y = NULL)
mont2012 <- plot(sm(bb_abund.2012, 10)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
muci2010 <- plot(sm(bb_abund.2010, 11)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. mucidis")), x = NULL, y = NULL)
muci2011 <- plot(sm(bb_abund.2011, 11)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. mucidis")), x = NULL, y = NULL)
muci2012 <- plot(sm(bb_abund.2012, 11)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
pasc2010 <- plot(sm(bb_abund.2010, 12)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. pascuorum")), x = NULL, y = NULL)
pasc2011 <- plot(sm(bb_abund.2011, 12)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. pascuorum")), x = NULL, y = NULL)
pasc2012 <- plot(sm(bb_abund.2012, 12)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
prat2010 <- plot(sm(bb_abund.2010, 13)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. pratorum")), x = NULL, y = NULL)
prat2011 <- plot(sm(bb_abund.2011, 13)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. pratorum")), x = NULL, y = NULL)
prat2012 <- plot(sm(bb_abund.2012, 13)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
psit2010 <- plot(sm(bb_abund.2010, 14)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. psithyrus")), x = NULL, y = NULL)
psit2011 <- plot(sm(bb_abund.2011, 14)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. psithyrus")), x = NULL, y = NULL)
psit2012 <- plot(sm(bb_abund.2012, 14)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
pyre2010 <- plot(sm(bb_abund.2010, 15)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. pyrenaeus")), x = NULL, y = NULL)
pyre2011 <- plot(sm(bb_abund.2011, 15)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. pyrenaeus")), x = NULL, y = NULL)
pyre2012 <- plot(sm(bb_abund.2012, 15)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
soro2010 <- plot(sm(bb_abund.2010, 16)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. soroensis")), x = NULL, y = NULL)
soro2011 <- plot(sm(bb_abund.2011, 16)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. soroensis")), x = NULL, y = NULL)
soro2012 <- plot(sm(bb_abund.2012, 16)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
...
wurf2010 <- plot(sm(bb_abund.2010, 17)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. wurflenii")), x = NULL, y = NULL)
wurf2011 <- plot(sm(bb_abund.2011, 17)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  guides(fill = FALSE) +
  #l_points() +
  labs(title = expression(italic("B. wurflenii")), x = NULL, y = NULL)
wurf2012 <- plot(sm(bb_abund.2012, 17)) +
  l_fitRaster() +
  l_fitContour(size = 0.1) +
  #l_points() +
  guides(fill = FALSE) +
...
plot(major_sp)
ggsave(major_sp, "./output/BB_abund_major.pdf")
plot(high_elev_sp)
plot(minor_sp)
```
